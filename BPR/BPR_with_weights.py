...
class BPR:
    def __init__(self, num_users, num_items, latent_dim=128, learning_rate=0.01, reg=0.025, k=10, epochs=10, max_users=1000):
        ...
        for epoch in range(epochs):
            ...
            if eval_df is not None:
                ...
                if current_precision > best_precision:
                    ...
                    no_improve_epochs = 0
                    self.save_bpr_model(user2id, item2id, path="best_model1_weighted.pkl")
                else:
                    no_improve_epochs += 1
